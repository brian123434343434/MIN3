<%@ page title="" language="VB" masterpagefile="~/MasterPages/SecurityDefault.master" autoeventwireup="false" inherits="Common_ChangePassword, App_Web_cenaxg5p" theme="GattacaAdmin" %>
                            ...
                            <table align="center" bgcolor="white" border="0" cellpadding="1" cellspacing="1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 373px; text-align: left;">
                                        ...
                                        <asp:Button ID="bntCancel" runat="server" CausesValidation="False" OnClientClick="javascript:window.history.back(-1);"
                                            Text="Cancelar" />
                                    </td>
                                </tr>
                            </table>
