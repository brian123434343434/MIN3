<%@ page language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_Depto_AddDepto, App_Web_qiclto3y" title="Departamento" theme="GattacaAdmin" %>
            ...
            <td colspan="2" style="text-align: center">
                <table border="0" cellpadding="1" cellspacing="1" align="center" bgcolor="white"
                    ...
                    <tr style="color: #333333">
                        ...
                        <td style="text-align: left">
                            <asp:DropDownList ID="ddlCountry" runat="server" Width="229px" BackColor="WhiteSmoke">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:RadioButtonList ID="rblHabilitado" runat="server" 
        ...
        <tr>
            <td colspan="2" style="text-align: center">
                ...
                <asp:Label ID="lblMessage" runat="server" CssClass="cssRequired" ForeColor="Red"
                    Visible="False">Si elimina los cambios no pueden ser revertidos. ¿Está seguro que desea eliminar?</asp:Label><br />
                <br />
