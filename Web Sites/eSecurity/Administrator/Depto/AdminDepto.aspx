<%@ page language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_Depto_AdminDepto, App_Web_qiclto3y" title="Administración de Departamentos / Estados" theme="GattacaAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%">
        <tr>
            <td colspan="2">
                <asp:Label ID="lblTitle" runat="server" CssClass="cssLabelTitle" Text="Administración de Departamentos / Estados"></asp:Label>
                <hr />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="gvData" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="AddDepto.aspx?Option=Edit&amp;Id={0}"
                        ...
                        <asp:BoundField DataField="Name" HeaderText="Departamento / Estado" />
