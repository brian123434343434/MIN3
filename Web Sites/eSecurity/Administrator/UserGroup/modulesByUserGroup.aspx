<%@ page title="" language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_UserGroup_ModulesByGroup, App_Web_hery_agv" theme="GattacaAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table id="Table1" border="0" cellpadding="1" cellspacing="1" width="100%">
        <tr>
            <td colspan="2">
                <asp:Label ID="lblTitle" runat="server" CssClass="cssLabelTitle">Administración de Modulos por Grupo de Usuarios<hr /></asp:Label>
                <asp:Label ID="lblCompanyName" runat="server" CssClass="cssLabelTitle"></asp:Label><asp:Label
                    ID="lblAreaName" runat="server" CssClass="cssLabelForm" Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <cc1:PickList ID="dlbModuleByUserGroup" runat="server" AddAllButtonText="Agregar todo &gt;&gt;"
