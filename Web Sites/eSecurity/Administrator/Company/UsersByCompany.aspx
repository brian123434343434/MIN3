<%@ page title="" language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_Company_UsersByCompany, App_Web__yjwvz_k" theme="SoftManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%">
        <tr>
            <td colspan="2">
                <asp:Label ID="lblTitle" runat="server" CssClass="cssLabelTitle" Text="Empleados de la Empresa"></asp:Label>
                <hr />
            </td>
        </tr>
        <tr>
            <td>
                ...
                <uc1:SearchControl ID="scSearchEngine" runat="server" Columns="Code,Código,String;Name,Nombre,String;EMail,E-Mail,String" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:GridView ID="gvData" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="~/Administrator/User/AddUser.aspx?Option=Edit&amp;Id={0}"
