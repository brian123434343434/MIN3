<%@ page title="" language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_Company_UserGroupsByCompany, App_Web__yjwvz_k" theme="SoftManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table id="Table1" border="0" cellpadding="1" cellspacing="1" width="100%">
        <tr>
            <td colspan="2">
                <asp:Label ID="lblTitle" runat="server" CssClass="cssLabelTitle">Administración de Grupos de Usuarios por Empresas<hr /></asp:Label>
        ...
        <tr>
            <td colspan="2">
                <cc1:PickList ID="dlbUserGroupsByCompany" runat="server" AddAllButtonText="Agregar todo &gt;&gt;"
