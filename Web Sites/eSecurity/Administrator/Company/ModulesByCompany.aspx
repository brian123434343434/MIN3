<%@ page title="" language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_Company_ModulesByCompany, App_Web__yjwvz_k" theme="SoftManagement" %>
...
<table id="Table1" border="0" cellpadding="1" cellspacing="1" width="100%">
        ...
        <tr>
            <td colspan="2">
                <cc1:PickList ID="dlbModulesByCompany" runat="server" AddAllButtonText="Agregar todo &gt;&gt;" 
