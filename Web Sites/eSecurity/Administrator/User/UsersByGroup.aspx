<%@ page title="" language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_User_UsersByGroup, App_Web_z2f_sopw" theme="SoftManagement" %>
...
<table id="Table1" border="0" cellpadding="1" cellspacing="1" width="100%">
        <tr>
            <td colspan="2">
                <asp:Label ID="lblTitle" runat="server" CssClass="cssLabelTitle">Administración de Grupos por Usuario<hr /></asp:Label>
