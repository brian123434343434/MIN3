<%@ page title="" language="VB" masterpagefile="~/MasterPages/Security.master" autoeventwireup="false" inherits="Administrator_User_UsersByModule, App_Web_z2f_sopw" theme="SoftManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table id="Table1" border="0" cellpadding="1" cellspacing="1" width="100%">
        <tr>
            <td colspan="2">
                <asp:Label ID="lblTitle" runat="server" CssClass="cssLabelTitle">Administración de Módulos por Usuario<hr /></asp:Label>
        ...
        <tr>
            <td colspan="2">
                <cc1:PickList ID="dlbUsersByModule" runat="server" AddAllButtonText="Agregar todo &gt;&gt;" 
