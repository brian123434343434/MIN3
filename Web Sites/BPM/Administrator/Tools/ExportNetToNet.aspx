<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/WorkFlowAdmin.Master"
    CodeBehind="ExportNetToNet.aspx.vb" Inherits="BPMWebSite.ExportNetToNet"
                ...
                <table id="Table1" border="0" cellpadding="1" cellspacing="1" class="cssTable">
                    <tr>
                        <td align="left" colspan="6" class="cssLabelTitle">
                            <asp:Label ID="lblTitle" runat="server" CssClass="cssLabelTitle">Exportar 
                            versión 8.3</asp:Label>
                            <br />
                            <br />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <asp:HyperLink ID="hlDownload" runat="server" Visible="False" CssClass="cssButton"
