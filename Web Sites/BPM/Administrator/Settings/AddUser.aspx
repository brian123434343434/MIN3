<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/WorkFlowAdmin.Master"
    CodeBehind="AddUser.aspx.vb" Inherits="BPMWebSite.AddUser" Title="Creación, Edición y Eliminación de Usuarios" %>
                ...
                <table align="center" bgcolor="White" border="0" cellpadding="1" cellspacing="1">
                    <tr>
                        ...
                        <td style="width: 430px">
                            <asp:TextBox ID="txtCode" runat="server" BackColor="WhiteSmoke" MaxLength="50" Width="225px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 430px">
                            <asp:TextBox ID="txtIdentification" runat="server" BackColor="WhiteSmoke" MaxLength="50"
                                Width="225px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtIdentification"
                                Display="Dynamic" ErrorMessage="Dato Requerido" Font-Bold="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 430px">
                            <asp:TextBox ID="txtFirstName" runat="server" BackColor="WhiteSmoke" MaxLength="50"
                                Width="225px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 430px">
                            <asp:TextBox ID="txtLastName" runat="server" BackColor="WhiteSmoke" MaxLength="50"
                                Width="225px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 430px">
                            ...
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPassword"
                                ...
                                Font-Bold="True" SetFocusOnError="True"></asp:CompareValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="cssFormFieldName" style="width: 211px">
                        ...
                        <td style="width: 430px">
                            <asp:TextBox ID="txtPositionName" runat="server" BackColor="WhiteSmoke" MaxLength="50"
                                Width="225px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtPositionName"
                                Display="Dynamic" ErrorMessage="Dato Requerido" Font-Bold="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 430px">
                            <asp:TextBox ID="txtemail" runat="server" BackColor="WhiteSmoke" MaxLength="100"
                                Width="225px"></asp:TextBox>
        ...
        <tr>
            <td style="text-align: center">
                ...
                <asp:Label ID="lblMessage" runat="server" CssClass="cssRequired" ForeColor="Red"
                    Visible="False">Si elimina, los cambios no pueden ser revertidos. Está seguro que desea eliminar?</asp:Label>
                <br />
                <asp:Label ID="lblErrorMessage" runat="server" CssClass="cssRequired" ForeColor="Red"></asp:Label>
                <br />
