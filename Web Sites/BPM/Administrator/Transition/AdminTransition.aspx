<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPages/WorkFlowAdmin.Master"
    Codebehind="AdminTransition.aspx.vb" Inherits="BPMWebSite.AdminTransition"
    Title="Gattaca WorkFlow - Administración de Transiciones" Theme="SoftManagement" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="Panel4" runat="server" CssClass="collapsePanelHeader" Height="30px">
                            <div style="padding: 5px; vertical-align: middle;">
                                <div style="float: left;">
                                    Crear Nuevas Transiciones</div>
                                <div style="float: right; vertical-align: middle;">
                                    <asp:Button ID="btnAdd" runat="server" Text="Adicionar Transición" />
                                </div>
                            </div>
                        </asp:Panel>
                        <asp:Panel ID="Panel2" runat="server" CssClass="collapsePanelHeader" Height="30px">
                            <div style="padding: 5px; vertical-align: middle;">
                                <div style="float: left;">
                                    Ver Transiciones Habilitadas</div>
                                <div style="float: right; vertical-align: middle;">
                        ...
                        <asp:Panel ID="ProcessHeader" runat="server" CssClass="collapsePanelHeader" Height="30px">
                            <div style="padding: 5px; cursor: pointer; vertical-align: middle;">
                                <div style="float: left;">
                                    Ver Transiciones por Proceso</div>
                        ...
                        <asp:Panel ID="Process" runat="server" CssClass="collapsePanel" Height="0">
                            ...
                            <p>
                                ...
                                <br />
                                <asp:Label ID="Label9" runat="server" Text="Seleccionar Actividad"></asp:Label>
                                <asp:DropDownList ID="cboActivity" runat="server" AutoPostBack="true">
                                </asp:DropDownList>
                            </p>
                        </asp:Panel>
                        ...
                        <asp:Panel ID="BasicSearch" runat="server" CssClass="collapsePanel" Height="0">
                            ...
                            <p>
                                ...
                                <asp:DropDownList ID="cboSearchField" runat="server">
                                    <asp:ListItem Value="Transition.ID">ID</asp:ListItem>
                                    <asp:ListItem Selected="True" Value="Transition.Code">Codigo</asp:ListItem>
                                    <asp:ListItem Value="Transition.Name">Nombre</asp:ListItem>
                                </asp:DropDownList>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:DropDownList ID="cboAdvanceField" runat="server">
                            <asp:ListItem Value="Transition.ID">ID</asp:ListItem>
                            <asp:ListItem Value="Transition.Code" Selected="True">Codigo</asp:ListItem>
                            <asp:ListItem Value="Transition.Name">Nombre</asp:ListItem>
                            <asp:ListItem Value="Transition.Enabled">Status</asp:ListItem>
                        </asp:DropDownList>
        ...
        <ContentTemplate>
            <asp:Panel ID="DataGridPanel" runat="server" BackColor="white" Width="99%">
                <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/Administrator/Transition/AddTransition.aspx?Operation=Update&amp;IdTransition={0}"
                        ...
                        <asp:TemplateField HeaderText="Actividad Inicial">
                            <ItemTemplate>
                                <asp:Label ID="lblFromActivity" runat="server" Text='<%# Eval("FromActivityName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Actividad Final">
                            <ItemTemplate>
                                <asp:Label ID="lblToActivity" runat="server" Text='<%# Eval("ToActivityName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Condiciones">
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <a class="lnk" href='AssignConditions.aspx?IdTransition=<%#Container.DataItem.ID%>&IDActivity=<%#Container.DataItem.FromActivity%>'>
