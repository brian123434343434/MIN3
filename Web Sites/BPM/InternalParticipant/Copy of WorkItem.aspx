            ...
            <td class="cssBkgWorkItem">
                ...
                <table id="tblActivityActions" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="cssGridTitle" style="color: #000080">
                            <asp:Label ID="lblPrivateComments" runat="server" Text="Observaciones para los participantes del proceso"></asp:Label> [Máximo 500 caracteres]
                        </td>
                        <td>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="cssGridTitle" style="color: #000080">
                            <asp:Label ID="lblPublicComments" runat="server" Text="Observaciones para el solicitante"></asp:Label> [Máximo 500 caracteres]
                        </td>
                        <td>
                        </td>
                    </tr>
