<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="BPMWebSite._Default3" %>
          ...
          <table width="474" height="0" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="162" valign="top"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><a href="#"><asp:Image Runat="Server" SkinID="Espanol" ID="Espanol"/></a></td>
                  <td>&nbsp;</td>
                  <td><a href="#"><asp:Image Runat="Server" SkinID="English" ID="English"/></a></td>
                  </tr>
              </table></td>
