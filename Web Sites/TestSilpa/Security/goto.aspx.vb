...
Partial Class Process_gotoWorkFlow
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        url = "?IdUser=" & appCred.UserID.ToString & "&LOGON_USER=" & User.Identity.Name & "&op=" & op & "&Client=" & appCred.ClientName
        ...
        Select Case app
            ...
            Case "FBApp"
                ...
                url = ConfigurationManager.AppSettings("formBuilderAppLogin") & _
                        "?type=" & type & "&Case=1&Form=" & op & "&IdRelated=" & appCred.UserID.ToString & _
